...
/**
 * This represents an immutable, generics path between two cartesian coordinate
 * unsure type of nodes, particularly Path#getStart() and Path#getEnd(). Also contains a cached
...
public class Path<N> implements Iterable<Path<N>.Segment> {
    ...
    /**
     * The type of node at the beginning of this path.
     */
    private N start;
    ...
    /**
     * Creates a new, empty path containing a start type of node. Essentially
     * this represents a path from the start type of node to itself with a total cost of "0".
     *
     * @param start The starting type of node of the path.
     */
    public Path(N start) {
        this.start = start;
        this.cost = 0;
    ...
    /**
     * Appends a new single segment to the end of this path, originating at the current last type of node
     ...
     * segmentCost}.
     *
     * @param newEnd      The typd of node being added at the end of the segment being appended to this path
    ...
    /**
     * @return The type of node at the beginning of this path.
     */
    public N getStart() {
        return start;
    }
    ...
    /**
     * @return The type of node at the end of this path, which may be the start point if this path
    ...
    /**
     * Segment represents a single segment as part of a longer, more complex path between type of nodes.
    ...
    public class Segment {
         ...
         *
         * @param start The starting type of nodes of this segment.
         * @param end   The ending type of nodes of this segment.
        ...
        /**
         * @return The beginning type of node of this segment.
         */
        public N getStart() {
        ...
        /**
         * @return The ending type of node of this segment.
         */
        public N getEnd() {
            return this.end;
        }
